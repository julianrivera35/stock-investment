  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 py-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-8">
        AnalystHub Dashboard
      </h1>

      <!-- Loading State -->
      <LoadingSpinner
        v-if="store.loading && !store.isInitialLoadComplete"
        :percentage="store.loadingPercentage"
        :current="store.currentRecommendationCount"
        :total="store.totalRecommendations"
      />
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-center">
              ...
              <span class="text-blue-700 text-sm">
                Loading remaining data... {{ store.loadingPercentage }}%
                complete
              </span>
            </div>
          </div>
